...
<!-- Exportable Table -->
              ...
              <div class="col-md-12">
                  ...
                  <div class="header" style="background-color:#2196F3;">
                        ...
                        <h2 style="color:white;">
                           ...
                           <h2 style="color:white;">
                           <% 
						      if(title.equalsIgnoreCase("Offering"))
						      {
						   %>
						      Add Offering
						   <%	  
        ...
        <%--          <% if(title.equalsIgnoreCase("Enquiry"))
                         { %>
			<div id="filediv" style="margin-top:19px;">

				    <form class="form-horizontal" method="post" action="import_file" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="row clearfix">
						...
						<div class="col-sm-12" align="center">
							...
							<input type="file" id="upload_file" name="upload_file" accept=".xlsx" required>
...
<!-- 									   <i class="material-icons">add</i> -->
									   ...
									   <button title="Import File" data-toggle="modal" data-target="#importfile"
								style="margin-top: 0px;margin-left: 6px;"
								class="btn bg-blue waves-effect waves-light" title="Import File">
								<!-- 									   <i class="material-icons">add</i> -->
								Import File
							    </button>
							    
							    
							     <button title="Searching file" data-toggle="modal" data-target="#searchingfile"
								style="margin-top: 0px;margin-left: 6px;"
								class="btn bg-blue waves-effect waves-light" title="Searching file">
								Search
							    </button>
						        ...
						        %>
								  ...
								  {
							   %>
							   <form action="saveOffering" method="post">
								  ...
								  <div class="row clearfix">
									 <div class="col-sm-12"  align="right" style="padding-right: 30px;">
									   ...
									   <div class="col-sm-2" style="">
                                          <label for="companyname"><span class="" style="color:red">*</span>Offering :</label>
	                                    </div>
	                                    
	                                    <div class="col-sm-2" style="width:20%">
	                                      <div class="form-group" ><div class="form-line">
	                                      <input type="text" id="offering" name="offering" class="form-control"  placeholder="Enter Offering" value="" required>
	                                      </div></div>
                                        </div>
									 
									 
									 
									   <button type="submit" class="btn bg-blue waves-effect waves-light"  title="Add Offering" style="margin-right:63%;">
<!-- 									   <i class="material-icons">add</i> -->
									   Add
									   </button>
...
<%-- 		                                          <td><fmt:formatDate pattern="dd-MM-yyyy" value="${enquiries.sourcingdate}" /></td>
 --%><%-- 		                                          <td>${enquiries.crmevent}</td> --%>
                                                      <td><fmt:formatDate pattern="dd-MMM-yy" value="${enquiries.creationdate}" /></td>
                                                 <td><fmt:formatDate pattern="dd-MMM-yy" value="${enquiries.flow_of_date}" /></td>
                                                  <%-- <td><fmt:formatDate pattern="dd-MMM-yy" value="${enquiries.forecastclose}" /></td> --%>
		                                        <td>${enquiries.calling_status}</td>
		                                        <%-- <td>${enquiries.calling_status_remark}</td> --%>
		                                         
		                                          <td>${enquiries.status}</td>
		                                          <td>${enquiries.assigneto.empfirstname } ${enquiries.assigneto.emplastname }</td>
...
<%-- 		                                              <td><fmt:formatDate pattern="dd-MM-yyyy" value="${leads.sourcingdate}" /></td>
 --%><%-- 		                                              <td>${leads.crmevent}</td> --%>
                                                 <td><fmt:formatDate pattern="dd-MMM-yy" value="${leads.creationdate}" /></td>
                                                 <%-- <td><fmt:formatDate pattern="dd-MMM-yy" value="${leads.lastupdateddate}" /></td> --%>
                                                 <td><fmt:formatDate pattern="dd-MMM-yy" value="${leads.forecastclose}" /></td>
		                                        <td>${leads.calling_status}</td>
		                                        <td>${leads.calling_status_remark}</td>
		                                        <td>${leads.status}</td>	
		                                        
		                                       <td>${leads.assigneto.empfirstname } ${leads.assigneto.emplastname }</td>
...
<%-- 		                                              <td>${customers.status}</td> --%>
                                                      <td><fmt:formatDate pattern="dd-MMM-yy" value="${customers.creationdate}" /></td>
                                                 <%-- <td><fmt:formatDate pattern="dd-MMM-yy" value="${customers.lastupdateddate}" /></td> --%>
                                                 <td><fmt:formatDate pattern="dd-MMM-yy" value="${customers.forecastclose}" /></td>
		                                        <%-- <td>${customers.calling_status}</td> --%>
		                                        <%-- <td>${customers.calling_status_remark}</td> --%>
		                                          ...
		                                          %>
		                                            ...
		                                            <td>${customers.assigneto.empfirstname } ${customers.assigneto.emplastname }</td>
...
<!-- 		                                              <td>Order</td> -->
<%-- 		                                              <td>${customers.status}</td> --%>
                                                      <td><fmt:formatDate pattern="dd-MMM-yy" value="${cancelled.creationdate}" /></td>
                                                 <%-- <td><fmt:formatDate pattern="dd-MMM-yy" value="${cancelled.lastupdateddate}" /></td> --%>
                                                 <%-- <td><fmt:formatDate pattern="dd-MMM-yy" value="${cancelled.forecastclose}" /></td> --%>
		                                        <td>${cancelled.calling_status}</td>
		                                        <td>${cancelled.calling_status_remark}</td>



													  <c:set var="custometstatus">${cancelled.isactivatedcustomer}</c:set>
		                                          <%
		                                          String custometstatus = (String) pageContext.getAttribute("custometstatus");
		                                          if(custometstatus.equalsIgnoreCase("Y"))
		                                          {
		                                          ...
		                                          %>
		                                            ...
		                                            <td>${cancelled.assigneto.empfirstname } ${cancelled.assigneto.emplastname }</td>
		                                      ...
		                                      %>
		                                       ...
		                                       <tr>
		                                          <td><%=j%></td>
		                                          <td>${Offerings.offeringdesc}</td>

		                                          
		                                        
		                                          <td><button type="button" class="btn btn-default waves-effect waves-light" title="Edit" data-toggle="modal" data-target="#editoffering"
															onclick="editOffering('${Offerings.offeringid}','${Offerings.offeringdesc}')">
															<i class="material-icons">edit</i>
														</button>
														
														<button type="button" class="btn btn-default waves-effect waves-light" title="Delete" data-toggle="modal" data-target="#"
															onclick="deleteOffering('${Offerings.offeringid}')">
															<i class="material-icons">delete</i>
														</button>
     ...
     <!-- end of Exportable Table -->
      ...
      <div class="modal fade" id="importfile" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
	      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
	          <div class="modal-content">
	                <div class="modal-header" style="background-color: #0073b1">
					     <h4 class="modal-title" id="addeventmodel" style="color: white">Import File</h4>
				    </div>
<!-- 				    <form class="form-horizontal" method="post" action="import_file" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data"> -->
 <form class="form-horizontal" method="post" action="uploadcrmfile" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data">
		...
		<div class="modal-footer" style="background-color:#0073b1">
				          <button type="submit"  class="btn btn-link waves-effect" id="" name="" style="color:white; font-weight: bold; font-size:12px;">Import</button>
...
<!--      Searching file  -->
       <!-- end of Exportable Table -->
      <div class="modal fade" id="searchingfile" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
	      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
	          <div class="modal-content">
	                <div class="modal-header" style="background-color: #0073b1">
					     <h4 class="modal-title" id="addeventmodel" style="color: white">Search</h4>
				    </div>
<!-- 				    <form class="form-horizontal" method="post" action="import_file" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data"> -->
            <form class="form-horizontal" method="post" action="enquiries" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data">
				    <div class="modal-body">
				    
     				<label style="font-weight: bold;margin-left: 6%;">Start Date : </label>
<input type="date" id="start_date" name="start_date" style="margin-bottom: 10px;">
                
<label style="font-weight: bold;margin-left: 8%;">End Date : </label>
<input type="date" id="end_date" name="end_date" style="margin-bottom: 10px;">
                   
<label style="font-weight: bold;margin-left: 9%;">Calling Status :</label>
<select class="" data-live-search="true" id="calling_status" name="calling_status" onchange="showleadinfodiv()" >
    ...
    <option value="Other">Other</option>
		...
		<div class="modal-footer" style="background-color:#0073b1">
				          <button type="submit"  class="btn btn-link waves-effect" id="" name="" style="color:white; font-weight: bold; font-size:12px;">Search</button>
					      <button type="button" class="btn btn-link waves-effect" data-dismiss="modal" style="color: white; font-weight: bold; font-size: 12px;" id="addeventclosebutton" name="addeventclosebutton" onmouseover="changemyaddeventclosecolor()" onmouseout="changeaddeventclosecolormouseOut()">Close</button>
	   </div>
         ...
         <div class="modal fade" id="editoffering" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
	      <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
	          <div class="modal-content">
	                <div class="modal-header" style="background-color: #0073b1">
					     <h4 class="modal-title" id="addeventmodel" style="color: white">Edit Offering</h4>
				    </div>
				    <form class="form-horizontal" method="post" action="updateOffering" name="fileForm" id="fileForm" autocomplete="off" enctype="multipart/form-data">
				    <div class="modal-body">
				       ...
				       <div class="col-sm-2" style="">
	                                   ...
	                                   <input type="hidden" id="offeringId" name="offeringId" class="form-control"  placeholder="" value="" required>
	                                    
	                                    
	                                    <div class="col-sm-2" style="width:20%">
	                                      <div class="form-group" ><div class="form-line">
	                                      <input type="text" id="editofferingtext" name="editofferingtext" class="form-control"  placeholder="" value="" required>
	                                      </div></div>
                                        </div>
		...
		<div class="modal-footer" style="background-color:#0073b1;margin-top:3%;">
				          <button type="submit"  class="btn btn-link waves-effect" id="" name="" style="color:white; font-weight: bold; font-size:12px;">Update</button>
					      <button type="button" class="btn btn-link waves-effect" data-dismiss="modal" style="color: white; font-weight: bold; font-size: 12px;" id="addeventclosebutton" name="addeventclosebutton" onmouseover="changemyaddeventclosecolor()" onmouseout="changeaddeventclosecolormouseOut()">Close</button>
	   </div>
												  	...
												  	<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="contactdetails">
												  		...
												  		<thead>
															<tr>
																...
																<th style="font-weight:normal;"><b>Contact Name</b></th>
																<th style="font-weight:normal;"><b>Designation</b></th>
																<th style="font-weight:normal;"><b>Mobile</b></th>
																<th style="font-weight:normal;"><b>Alt No</b></th>
																<th style="font-weight:normal;"><b>Email</b></th>
				             ...
				             <div class="" id="converttoleads" style="display:none">
				                   ...
				                   <div class="row clearfix">
		    							...
		    							<div class="col-sm-2" style="width:15%">
		    								<div class="form-group">
	                                        	<div class="form-line">
	                                                <select class="form-control show-tick" data-live-search="true" id="chanceofsale" name="chanceofsale" onchange="callMargin()" required>
	                                                	<option value="">Select</option>
		    							...
		    							<div id="margin_d" style="display:none;">
		    							 <div class="col-sm-2" style="width:13%">
                                          <label for="chanceofsale"><span class="" style="color:red">*</span>Margin(%) :</label>
	                                    </div>
		    							<div class="col-sm-2" style="width:12%">
	    								<div class="form-group" >
                                        	<div class="form-line">
				                 ...
				                 <div class="row clearfix" id="globle12" style="display: none;">
				                   ...
				                   <div class="col-sm-2"  id="fore12" style="margin-left:7%;">
				                  ...
				                  <div class="row clearfix">
				                    ...
				                    <div class="row clearfix" style="margin-top: 3%; margin-left: -4%;">
				                         <div class="col-sm-2" style="width:12%">
	                                       <label for="ponumber" style="margin-left: 25px;"><span class="" style="color:red">*</span>PO Number:</label>
		                                 </div>
		                                
		                                <div class="col-sm-2" style="width:20%; margin-left:2%">
		                                    <div class="form-group" ><div class="form-line">
				   ...
				   <form class="form-horizontal" method="post" action="savemodifiedDetails" name="modifieddetails" id="modifieddetails" autocomplete="off" enctype="multipart/form-data">
				         <div class="modal-body">
				               ...
				               <div class="row clearfix" style="padding-top: 15px;">
				                   ...
				                   <div class="col-sm-2" style="width:14%">
		                                ...
		                                <div class="col-sm-2" style="margin-left:-39px;">
		                                      <div class="form-group" ><div class="form-line">
	                                          <input type="text" id="industry_of_company" name="industry_of_company" class="form-control"  placeholder="" value="" >
		                                      </div></div>
		                                </div>
		    						...
		    						<div class="col-sm-2" style="width:13%; margin-left:30px;">
		    								<div class="form-group" >
	                                        	<div class="form-line">
		    							...
		    							<div class="col-sm-2" style="width:10%; margin-left:3%">
		    								<label for="Address">Address1:</label>
	                                </div>
		    						
		    						<div class="col-sm-2" style="width:13%; margin-left:4%">
		    								<div class="form-group" >
	                                        	<div class="form-line">
				              ...
				              <div class="row clearfix" style="padding-top: 15px;">
		    						...
		    						<div class="col-sm-2" style="width:15%; margin-left:-3%;">
		    								<div class="form-group" >
	                                        	<div class="form-line">
	    							...
	    							<div class="col-sm-2" style="width:15%; margin-left:-2%;">
		    								<label for="City">City :</label>
	                                </div>
		    						
		    						<div class="col-sm-2" style="width:12%; margin-left:-2%;">
		    								<div class="form-group" >
	                                        	<div class="form-line">
		    						 ...
		    						 <div class="col-sm-2" style="width:09%; margin-left:4%;">
	    								<label for="country"><span class="" style="color:red">*</span>Region :</label>
                                	</div>
                                	
                                	<div class="col-sm-2" style="width:14%; margin-left:5%;">
	    								<div class="form-group">
                                        	<div class="form-line" >
				               ...
				               <div class="row clearfix" style="padding-top: 15px;">
                                	...
                                	<div class="col-sm-2" style="width:15%; margin-left:-3%; display:block" id="countrys1">
	    								<div class="form-group">
                                        	<div class="form-line">
                                               <input type="text" id="countrys" name="countrys" class="form-control" onclick=""  placeholder="" >
                                            </div>
                                    	</div>
	    							</div>
	    							
	    							<div class="col-sm-2" style="width:15%; margin-left:-2%;"  class="state" id="state" >
	    								<label for="state" ><span style="color:red">*</span>State:</label>
                                	</div>
                                	
                                	<div class="col-sm-2" style="width:12%; margin-left:-2%; display:none" id="indianstate">
	    								<div class="form-group">
                                        	<div class="form-line" >                          
	    							...
	    							<div class="col-sm-2" style="width:12%; margin-left:-2%; display:none" id="otherthanindianstate">
	    								<div class="form-group">
                                        	<div class="form-line" >
	    							...
	    							<div class="col-sm-2" style="width:10%; margin-left:4%;" id="districts" class="districts">
	    								<label for="district" ><span style="color:red">*</span>District:</label>
                                	</div>
                                	
                                	<div class="col-sm-2" style="width:12%; display:none; margin-left:4%;" id="indiandistricts">
	    								<div class="form-group">
                                        	<div class="form-line" >                          
	    							...
	    							<div class="col-sm-2" style="width:12%; margin-left:4%; display:none" id="otherthanindiandistricts">
	    								<div class="form-group">
                                        	<div class="form-line" >
                                	...
                                	<div class="col-sm-2" style="width:15%; margin-left:-2%;">
                                        	...
                                        	<div class="form-line">
                                                <select class="form-control show-tick" data-live-search="true" id="editannualturnover" name="editannualturnover" onchange="" required>
                                                	...
                                                	<option value="1000 and more">1000 and more</option>
	    													     	      	...
	    													     	      	<div class="col-sm-2" style="width:9%; margin-left:1%;">
                                          <label for="status"><span class="" style="color:red">*</span>Call Status :</label>
	                                    </div>
		    						
		    							<div class="col-sm-2" style="width:15% ; margin-left:4%; padding-left:22px; display:none;" id="callingstatusdiv" >
		    								<div class="form-group">
	                                        	<div class="form-line">
	                                                <select class="form-control show-tick" data-live-search="true" id="calling_status" name="calling_status" >
		    							...
		    							<div class="col-sm-2" id="callingstatustextdiv" style="width:15% ; margin-left:4%; padding-left:22px;  display:block;">
		                                      <div class="form-group" ><div class="form-line">
	                                          <input type="text" id="call_status_text" name="call_status_text" class="form-control"  placeholder="" value="" onclick="showcallingstatusdiv()">
		                                      </div></div>
		                                </div>
                                	   ...
                                	   <div class="col-sm-2" style="width:9%;">
		                                ...
		                                <div class="col-sm-2" style="margin-left: 2%;">
		                                 ...
		                                 <div class="col-sm-2" style="width:10%; margin-left:-1%;">
                                          <label for="status"><span class="" style="color:red">*</span>Status :</label>
	                                    </div>
		    						
		    							<div class="col-sm-2" id="statusDiv" style="margin-left:3%; width:15%; display:none" >
		    								<div class="form-group">
	                                        	<div class="form-line">
	                                                <select class="form-control show-tick" data-live-search="true" id="final_status" name="final_status" onchange="checkStatus()" required>
	                                                	<option value="">Select</option>
	                                                    <option value="Enquiry">Enquiry</option>
	                                                    <option value="Converted to Lead">Lead</option>
	                                                    <option value="PO">Order</option>
		    							...
		    							<!-- onclick="showStatusDiv()" -->
		    							
		    							<div class="col-sm-2" id= "statusDivText" style="margin-left:5%; display:block;" >
		                                      <div class="form-group" ><div class="form-line">
	                                          <input type="text" id="status_text" name="status_text" class="form-control"  placeholder="" value=""  readonly>
		                                      </div>
		                                </div>
				              ...
				              <!-- Assign To -->
				               ...
				               <div class="col-sm-2" style="width:14%; margin-left:1%;">
                                	       ...
                                	       <div class="col-sm-2" style="width:15%;">
			    								<div class="form-group">
		                                        	<div class="form-line">
		                                                <select class="form-control show-tick" data-live-search="true" id="editassigneto" name="editassigneto" onchange="setprimarysales()"  >
		                                                	<option value="">Select</option>
		                                                </select>
		                                        	</div>
		                                    	</div>
				                ...
				                <div class="row clearfix" style="padding-top: 15px;">
	    							...
	    							<div class="col-sm-2" style="width:19%">
	    								<div class="form-group">
                                        	<div class="form-line">
                                                <input type="Date" id="editflow_of_Date" name="editflow_of_Date" class="form-control"  placeholder="" value="" >
                                        	</div>
                                    	</div>
	    							</div>
				               ...
				               <div class="row clearfix" style="padding-top: 15px;">
		                                	...
		                                	<div class="col-sm-2" style="width:15%; margin-left:-7px; display:none;">
                                          <label for="needbydate" style="margin-left: 24px;"><span class="" style="color:red">*</span>Need By Date:</label>
	                                	</div>
	                                	...
	                                	<div class="col-sm-2" style="width:15%; display:none;">
				                          ...
				                          <div class="" id="converttopo" style="display:none;">
				                    <div class="row clearfix" style="margin-left : -41px; padding-top : 15px;" >
				                         <div class="col-sm-2" style="width:12%">
	                                       <label for="ponumber" style="margin-left: 25px;"><span class="" style="color:red">*</span>PO Number:</label>
		                                 </div>
		                                ...
		                                <div class="col-sm-2" style="width:15%; margin-left:-53px;">
		                                    <div class="input-group date" id="bs" >
		                                        <div class="form-line">
		                                            <input type="text" class="form-control" name="podate" id="podate" placeholder="Please choose a date...">
		                                        </div>
		                                ...
		                                <div class="col-sm-2" style="width:15%; margin-left:11px;">
	                                       <label for="poamount"><span class="" style="color:red">*</span>PO Amount:</label>
		                                </div>
				              ...
				              <input type="hidden" id="contactdetsize" name="contactdetsize" value="0">
											   ...
											   <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="editcontactdetails">
												  	<thead>
															<tr>
																...
																<th style="font-weight:normal;"><b>Alt Email</b></th>
																<th style="font-weight:normal;"><b>Authority</b></th>
																<th style="font-weight:normal;"><b>Action</b></th>
															</tr>
													 </thead>
				               ...
				               <!--  newly added code -->
				                ...
				                <div class="row clearfix" id="editconverttoleads" style="display:none;padding-left:20px;">
				                	<div class="row clearfix" style="padding-top: 15px;">
				                         <div class="col-sm-2" style="width:15%">
                                          <label for="editprojectdesc"><span class="" style="color:red">*</span>Opportunity Discription:</label>
	                                     </div>
...
<!-- 		                                    </div> -->
	                                  ...
	                                  <div class="row clearfix">
			    							...
			    							<div class="col-sm-2" style="width:15%">
			    								<div class="form-group">
		                                        	<div class="form-line">
		                                                <select class="form-control show-tick" data-live-search="true" id="editchanceofsale" name="editchanceofsale" onchange="showMarginDiv()" required>
		                                                <option value="Next level meet">Next level meet</option>
	                                                	<option value="Demonstration">Demonstration</option>
	                                                	<option value="POC">POC</option>
	                                                	<option value="Proposal expected">Proposal expected</option>
			    							...
			    							<div id="margin_div" style="display:none;">
			    							 <div class="col-sm-2" style="width:13%">
	                                          <label for="editchanceofsale"><span class="" style="color:red">*</span>Margin(%) :</label>
		                                    </div>
		                                    <div class="col-sm-2" style="width:18%;">
		                                      <div class="form-group" >
		                                      <div class="form-line">
	                                          <input type="text" id="edit_margin" name="edit_margin" class="form-control" onkeypress="return isNumber(event)"  placeholder="" value="">
		                                      </div>
		                                      </div>
		                                    </div>
			    							</div>
	                                    ...
	                                    <div class="col-sm-2" style="width:15%">
	                                      <div class="input-group date" id="bs_datepicker_component_container">
	                                        <div class="form-line">
	                                            <input type="text" class="form-control" name="forecastclosedate1" id="forecastclosedate1" placeholder="Please choose a date..." >
	                                        </div>
	                                        <span class="input-group-addon">
	                                            <i class="material-icons">date_range</i>
	                                        </span>
	            ...
	            <div class="modal-content">
				    ...
				    <div class="modal-body" >
				           ...
				           <div class="row clearfix">
		    					...
		    					<div class="col-sm-2" style="margin-left: 75px;width:13%">
		    					...
		    					<div class="col-sm-2" style="margin-left: 100px;width:15%">
	    				    ...
	    				    <div class="row clearfix" id="viewconverttoleads" style="display:none;padding-left:15px;">
	    					      <div class="row clearfix">
	    					           <div class="col-sm-2" style="width:13%">
	    								<label for="viewprojectdesc">Opportunity Discription:</label>
                                       </div>
			    				...
			    				<div class="row clearfix">
			    					  ...
			    					  <div class="col-sm-2" style="width:13%; margin-left:54px;">
		                              ...
		                              <div class="col-sm-2" style="width:13%">
			    						 <div class="form-group">
		                                        	<div class="form-line">
		                                               <input type="text" id="margin_text" name="margin_text" class="form-control" onchange=""  placeholder="" readonly>
		                                            </div>
		                                  </div>
			    					  </div>
			    				      ...
			    				      <div class="col-sm-2" style="width:13%">
	    								<label for="viewpotentialopp">Exp Deal value(INR):</label>
                                      </div>
			    					    ...
			    					    <div id="currentType" class="col-sm-2" style="width:13%;>
			    					    ...
			    					    <div class="col-sm-2" style="margin-left: 100px;width:15%">
	    								<label for="viewpotentialopp">Deal value:</label>
                                      </div>
                                	
		                                <div class="col-sm-2" style="width:15%; margin-left:-73px;" >
			    								<div class="form-group">
		                                        	<div class="form-line">
	    					...
	    					<!-- calling history div -->
	    					<div class="row clearfix" style="background-color:#eee;margin-right: 0px;" id="callingHistoryDiv1">
								    <div class="col-sm-2 form-control-label" style="text-align: left"><h6>Calling History :</h6></div>
									<div class="col-sm-2">
										<button type="button" class="btn btn-circle waves-effect waves-circle waves-float" id="history" onclick="showhistorydiv()" style="background-color: #eee;  font-size:12px; width:25%; height:20%;">
									     <i class="material-icons">keyboard_arrow_down</i>
								         </button> 
								    </div>
							  </div>
							  
							  <div id="viewhistorydiv" style="display:none;">
	    					    <div class="row clearfix">
	    					     <div class="col-md-12">
                                      <div class="table-responsive" id="" style="">
	    					               <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="historyTable1">
	    					                        <thead>
															<tr>
																<th style="font-weight:normal;"><b>Sr.No.</b></th>
																<th style="font-weight:normal;"><b>Calling Date</b></th>
																<th style="font-weight:normal;"><b>Calling Status</b></th>
																<th style="font-weight:normal;"><b>Remark</b></th>
													 ...
													 <tr>
																...
																<td style="font-weight:normal;">ABC</td>
																<td style="font-weight:normal;">PQR</td>
																<td style="font-weight:normal;">STV</td>
																
															</tr>
															
															 <tr>
																<td style="font-weight:normal;">2</td>
																<td style="font-weight:normal;">ger</td>
																<td style="font-weight:normal;">yut</td>
																<td style="font-weight:normal;">cvb</td>
	    					               ...
	    					               <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="viewcontactdetails">
	    					                        <thead>
															<tr>
																...
																<th style="font-weight:normal;"><b>Designation</b></th>
																<th style="font-weight:normal;"><b>Mobile</b></th>
																<th style="font-weight:normal;"><b>Office No</b></th>
																<th style="font-weight:normal;"><b>Email</b></th>
																<th style="font-weight:normal;"><b>Alt Email</b></th>
																<th style="font-weight:normal;"><b>Authority</b></th>
															</tr>
				                               ...
				                               <div class="form-group">
				                                    <div class="body table-responsive">
				                                        ...
				                                        <thead>
	                                						<tr>
	                                						    <th style="font-weight:normal;"><b>Sr No</b></th>
	                                							<th style="font-weight:normal;"><b>Event</b></th>
	                                							<th style="font-weight:normal;"><b>Event Stages</b></th>
	                                							<th style="font-weight:normal;"><b>Status</b></th>
	                                							<th style="font-weight:normal;"><b>Event Date</b></th>
	                                							<th style="font-weight:normal;"><b>Remark</b></th>
	                                						</tr>
	                                					</thead>
...
<!-- 	    				<button onclick="Validate()" type="button" class="btn btn-success" id="validateButton"><i class="fas fa-shield-check"></i> Check</button> -->
					     		...
					     		<div class="form-group">
					     			<div class="body table-responsive">
					     				 ...
					     				 <thead>
	                                			<tr>
	                                				<th style="font-weight:normal;"><b>Sr No</b></th>
	                                				<th style="font-weight:normal;"><b>Project Description</b></th>
	                                				<th style="font-weight:normal;"><b>Technologies</b></th>
	                                				<th style="font-weight:normal;"><b>PO Number</b></th>
	                                				<th style="font-weight:normal;"><b>Order Date</b></th>
	                                				<th style="font-weight:normal;"><b>Amount</b></th>
	                                				<th style="font-weight:normal;"><b>Need By Date</b></th>
	                                				<th style="font-weight:normal;"><b>Update</b></th>
	                                				<th style="font-weight:normal;"><b>Download</b></th>
                                		...
                                		<tr>
	                               		...
	                               		<th colspan="2"><span><button type="button" class="btn bg-blue waves-effect waves-light" title="Add New Order" onclick="openNewDeal()">New Order</button><span></th>
	                               		</tr> 
                                		</tfoot>
	...
	<div class="modal fade" id="adddeal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
			 <div class="modal-content">
			 	<div class="modal-header" style="background-color:#0073b1">
					   <h4 class="modal-title" id="newdealcrm" style="color:white">Add New Order</h4>
				</div>
				...
				<div class="modal-body">
					<div class="row clearfix">
							<div class="col-sm-2" style="width:17%">
                                 <label for="dealprojectdesc"><span class="" style="color:red">*</span>Opportunity Description:</label>
	                        </div>
	                ...
	                <div class="row clearfix">  
	                        ...
	                        <div class="col-sm-2" style="width:20%">
	                             <select class="form-control show-tick" data-live-search="true" id="dealevent" name="dealevent"   >
                                       <c:forEach items="${crmevents}" var="crmevents">
	                                           <option value="${crmevents.crmevent}">${crmevents.crmevent}</option>
	                                    </c:forEach>
                                  </select>
	    				...
	    				<div class="col-sm-2" style="width:10%">
                                 <label for="dealneedbydate"><span class="" style="color:red">*</span>Need By Date:</label>
                        </div>
		...
		<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
			 <div class="modal-content">
				...
				<div class="modal-body">
					<div class="row clearfix">
							<div class="col-sm-2" style="width:15%">
                                 <label for="dealprojectdesc"><span class="" style="color:red">*</span>Opportunity Discription:</label>
	                        </div>
...
<!-- T	 -->
	...
	function editOffering(offeringId , offeringName){
		//alert(offeringName);
		$('#offeringId').val(offeringId);
		$('#editofferingtext').val(offeringName);
	...
	function deleteOffering(offeringId){
		...
		$.ajax({
	      		type: 'GET',
	   	 		...
	   	 		url :'${pageContext.request.contextPath}/deleteOffering',
	   	 		success : function(data){
	   	 			if(data != null){
	   	 			alert(data);
	   	 		window.location.href='addOffering';
	   	 			}
	   	 		}
	...
	function showMarginDiv(){
		//alert('hi');
		var v = $('#editchanceofsale').val();
		if(v != ''){
			if(v == 'License reselling'){
				//alert('match');
			...
			alert("Please select winning stage !")
		}
		
	}
	function callMargin(){
		//alert('hi');
		var v = $('#chanceofsale').val();
		if(v != ''){
			if(v == 'License reselling'){
				//alert('match');
				$('#margin_d').css('display' , 'block');
			}else{
				$('#margin_d').css('display' , 'none');	
			}
		}else{
			alert("Please select winning stage !")
		}
...
function checkStatus(){
	...
	var s = $('#final_status').val();
	
	//alert(s);
	if(s == 'Converted to Lead'){
...
function showedinternationalcountrysdiv(){
	...
	function warning()
	{
		     ...
		     if(msg == "'successpo'")
		   	  {
		   	    swal({title: "Done", text: "Customer Added Successfully!", icon:"success"}).then(function(){ 
	           ...
	           if(msg == "'donedeal'")
		    	  {
		    	    swal({title: "Done", text: "Order Added Successfully!", icon:"success"}).then(function(){ 
		  			      window.location.href="customers";
		    	 		});
		    	  }
	           ...
	           if(msg == "'cancelled'")
			   	  {
			   	    swal({title: "Done", text: "Lead Cancelled Successfully!", icon:"success"}).then(function(){ 
...
<!--      </script> -->
	...
	function showhistorydiv()
	{
		 ...
		 var x = document.getElementById("viewhistorydiv");
  		 var y = document.getElementById('viewhistorydiv').style.display;
	  		if(y == "block")
				{
	  		      $('#history').html("<i class='material-icons'>keyboard_arrow_down</i>");
				  x.style.display = "none";
				}
				else
				{
				  $('#history').html("<i class='material-icons'>keyboard_arrow_up</i>");
				  x.style.display = "block";
				}
	}
...
// 						 }
	 ...
	 function AddRow()
	  {
		  ...
		  +'<td class="text-center" style="min-width: 150px; width: 150px;"><div class="form-group" ><div class="form-line"><input type="text" class="form-control" style="width:100%;color:black;text-align:centre;" id="document_name'+lenthtable+'" name="document_name" maxlength="100" placeholder="Enter Document Description"/></div></div></td>'
	 ...
	 function AddRowDeal()
	  {
		  ...
		  $('#deal tbody tr').last().after('<tr id="test1'+lenthtable+'">'
				  ...
				  +'<td class="text-center" style="min-width: 150px; width: 150px;"><div class="form-group" ><div class="form-line"><input type="text" class="form-control" style="width:100%;color:black;text-align:centre;" id="dealdocument_name'+lenthtable+'" name="dealdocument_name" maxlength="100" placeholder="Enter Document Description"/></div></div></td>'
	 ...
	 function setDetailsforEditEvent(crmid)
	 {
		 ...
		 $.ajax({
				type: 'GET',
			 		dataType: 'json',
			 		url :'${pageContext.request.contextPath}/getAssignToEmployees',
			 		success : function(data){
			 		var options = '';
			 		for (var i = 0; i < data.length; i++) {
                    //alert(data[i].empid );
			 			options += '<option value="' + data[i].empid + '">' + data[i].empfirstname +' '+data[i].emplastname+'</option>';
 		 	 				 			
			 		}
			 		
			 		    $("#editassigneto").append(options);
		 				$("#editassigneto").selectpicker("refresh");	
			 	}
		 ...
		 $.ajax({
				...
				dataType: 'json',
		 		...
		 		success : function(data)
		 		{
		 			...
		 			//alert(data.forecastdatestr);
		 			
// 		 			alert("data===>"+data);
console.log(data); 
		 			
		 			 $('#assigntopara').text('('+data.assigneto.empfirstname+' '+data.assigneto.emplastname+')');
			 		 $("#editrecordstitle").val(data.crmtype);
			 		 $("#editacemrecordsid").val(data.crmrecordid);
			 		 $("#edit_margin").val(data.margin);

			 		$("#editcompanyname").val(data.companyname);
			 		$("#calling_status_remark").val(data.calling_status_remark);
			 		$("#status_text").val(data.status);
		 			$("#call_status_text").val(data.calling_status)
		 			$("#industry_of_company").val(data.industry_of_company);
		 			$("#alternative_email_id").val(data.alternative_email_id);
		 			$("#editemployeesize option[value='"+data.employeesize+"']").prop("selected",true);
		 			$("#editemployeesize").selectpicker("refresh");

		 			$('#para').text('('+data.forecastdatestr+')')
		 			...
		 			$("#designation_of_prospect").val(data.designation_of_prospect);
...
// 		 			alert("=====>"+data.flow_of_date);
		 			
		 			let formattedDate1 = new Date(data.flow_of_date);
		 			formattedDate1.setDate(formattedDate1.getDate() + 1);
		 			formattedDate1 = formattedDate1.toISOString().split("T")[0];
		 			
		 			 // Convert to a valid 'YYYY-MM-DD' format for <input type="date">
		 			  let formattedDate = new Date(data.flow_of_date).toISOString().split("T")[0];

		 			  // Set value in input field
		 			  //document.getElementById("editflow_of_Date").value = formattedDate;
		 			
		 			$("#editflow_of_Date").val(formattedDate1);
...
// 		    	     c.style.display = "none";
	 ...
	 function AddRowforEdit()
	 {
		 ...
		 $('#editcontactdetails tbody tr').last().after('<tr id="test'+(lenthtable)+'">'
				  ...
				  +'<td><input type="text" class="form-control email" id="editcontactemail'+lenthtable+'" name="editcontactemail" placeholder="Ex: example@example.com" onchange="editvalidateEmail('+lenthtable+')" ></td>'
...
//                     	   alert("inside DelExistLeadDocument success "+data.errorDescription);
	 ...
	 function showcallingstatusdiv()
	 {
		 var x = document.getElementById("callingstatusdiv");
		 
		 var y = document.getElementById("callingstatustextdiv");
	 ...
	 function showStatusDiv()
	 {
		 ...
		 var y = document.getElementById("statusDivText");
	 ...
	 function submitmodifieddetails()
	 {
		 ...
		 var calling_status = $('#call_status_text').val();
		 //calling_status
		//  var calling_status1 = $('#calling_status').val();

		 var calling_remark = $('#calling_status_remark').val();
	  ...
	  <script type="text/javascript">
	       ...
	       function setDetailsforview(crmid)
	       {
	    	   ...
	    	   $.ajax({
				    type:'GET',
					dataType: 'json',
			 		url :'${pageContext.request.contextPath}/getHistoryDetails',
			 		data : ({'crmid':crmid}),
			 		success : function(data)
			 		{
			 		...
			 		//	alert(data);
			 				...
			 				for(var i=0;i<data.length;i++)
			 				{
			 				  p.row.add( [
		  	 			            i+1,
		  	 			            data[i].callingdatestr,
		  	 			            data[i].calling_status,
		  	 			            data[i].calling_remark,
	    	   ...
	    	   if(recordstitle === "enquiry")
	    		   {
	    		      document.getElementById("viewdetailsmodel").innerHTML = "Enquiry Details";
		    		   $('#callingHistoryDiv1').css('display' , 'block');
	    	   ...
	    	   if(recordstitle === "Lead")
    		   {
	    		   ...
	    		   $('#currentType').css('margin-left' , '33px');
	    		   $('#callingHistoryDiv1').css('display' , 'block');
	    	   ...
	    	   if(recordstitle === "Customer")
    		   {
	    		   ...
	    		   $('#callingHistoryDiv1').css('display' , 'none');
    		   }
